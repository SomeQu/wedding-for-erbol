...
const translations = {
	...
	ky: {
		...
		greetingMain: 'Урматтуу коноктор! Биздин сүйүү жомогубуздун эң бактылуу күнүн чогуу майрамдоого чакырабыз!',
		greetingSub: 'Эки жүрөк бир болгон бул кечте сиздин катышууңуз биз үчүн чыныгы бакыт.'
	}
} as const;
