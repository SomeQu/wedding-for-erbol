...
const translations = {
	ru: {
		...
		greetingMain: 'С большой радостью приглашаем вас на наш первый семейный праздник — нашу свадьбу!',
		greetingSub: 'В этот волшебный день мы скажем друг другу «Да» и соединим сердца и судьбы в кругу близких и родных.'
	},
	ky: {
		...
		greetingMain: 'Чоң кубаныч менен сиздерди биздин биринчи үй-бүлөлүк майрамга — биздин тойго чакырабыз!',
		greetingSub: 'Бул сыйкырдуу күнү биз бири-бирибизге «Ооба» деп айтып, жакындардын жана туугандардын чөйрөсүндө жүрөктөрүбүздү бириктиребиз.'
	}
} as const;
